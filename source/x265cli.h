...
static const struct option long_options[] =
{
    ...
    { "hdr-luma-qp", required_argument, NULL, 0 },
    { "hdr-scaling-list", no_argument, NULL, 0 },
    { "no-hdr-scaling-list", no_argument, NULL, 0 },
    { "hdr-pq", no_argument, NULL, 0 },
    { "no-hdr-pq", no_argument, NULL, 0 },
